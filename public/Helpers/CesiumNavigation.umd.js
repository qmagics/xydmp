(function (global, factory) {
  ...
  var getElement = zccity.getElement;
  var Knockout = zccity.knockout;
  ...
  var defined = zccity.defined;
  var DeveloperError = zccity.DeveloperError;
  var EllipsoidGeodesic = zccity.EllipsoidGeodesic;
  var Cartesian2 = zccity.Cartesian2;
  var getTimestamp = zccity.getTimestamp;
  var EventHelper = zccity.EventHelper;
  var Knockout$1 = zccity.knockout;
  ...
  var defined$2 = zccity.defined;
  var defineProperties = zccity.defineProperties;
  var DeveloperError$1 = zccity.DeveloperError;
  var Knockout$2 = zccity.knockout;
  /**
  ...
  var defined$3 = zccity.defined;
  var Camera = zccity.Camera;
  var Rectangle = zccity.Rectangle;
  var Cartographic = zccity.Cartographic;
  /**
        ...
        if (this.terria.options.defaultResetView && this.terria.options.defaultResetView instanceof Cartographic) {
          ...
          try {
            ...
            camera.flyTo({
              ...
              orientation: {
                heading: zccity.Math.toRadians(5.729578)
              }
            });
          } catch (e) {
  ...
  /* eslint-disable no-unused-vars */
  var defined$4 = zccity.defined;
  var Ray = zccity.Ray;
  var Cartesian3 = zccity.Cartesian3;
  var Cartographic$1 = zccity.Cartographic;
  var ReferenceFrame = zccity.ReferenceFrame;
  var SceneMode = zccity.SceneMode;
  var Utils = {};
  ...
  var defined$5 = zccity.defined;
  var Ray$1 = zccity.Ray;
  var IntersectionTests = zccity.IntersectionTests;
  var Cartesian3$1 = zccity.Cartesian3;
  var SceneMode$1 = zccity.SceneMode;
  /**
   * The model for a zoom in control in the navigation control tool bar
   *
  ...
  var defined$6 = zccity.defined;
  var CesiumMath = zccity.Math;
  var getTimestamp$1 = zccity.getTimestamp;
  var EventHelper$1 = zccity.EventHelper;
  var Transforms = zccity.Transforms;
  var SceneMode$2 = zccity.SceneMode;
  var Cartesian2$1 = zccity.Cartesian2;
  var Cartesian3$2 = zccity.Cartesian3;
  var Matrix4 = zccity.Matrix4;
  var BoundingSphere = zccity.BoundingSphere;
  var HeadingPitchRange = zccity.HeadingPitchRange;
  var Knockout$3 = zccity.knockout;
  ...
  function orbit(viewModel, compassElement, cursorVector) {
    ...
    viewModel.orbitTickFunction = function (e) {
      ...
      } // viewModel.terria.zccity.notifyRepaintRequired();
    ...
    function updateAngleAndOpacity(vector, compassWidth) {
      ...
      viewModel.orbitCursorOpacity = easedOpacity; // viewModel.terria.zccity.notifyRepaintRequired();
    }
  ...
  /* eslint-disable no-unused-vars */
  var defined$7 = zccity.defined;
  var definedProperties = zccity.defineProperties;
  var CesiumEvent = zccity.Event;
  var Knockout$4 = zccity.knockout;
  var DeveloperError$2 = zccity.DeveloperError;
  /**
